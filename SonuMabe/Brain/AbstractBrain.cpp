...
shared_ptr<ParameterLink<string>> AbstractBrain::brainTypeStrPL = Parameters::register_parameter("BRAIN-brainType", (string) "Human", "brain to be used in evolution loop, [Markov, Wire, Human, ConstantValues]");  // string parameter for outputMethod;
